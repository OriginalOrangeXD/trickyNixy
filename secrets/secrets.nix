...
# Get a host's pubkey:               ssh robby@<host> 'cat /etc/ssh/ssh_host_ed25519_key.pub'
#
# The host key matters because the running NixOS box uses it to decrypt
# secrets at boot — without it, the systemd unit can't read its secret.
